...
import {Avatar, Grid, styled, TextField} from "@mui/material";
            ...
            <Grid container rowSpacing={2} padding={4}>
                ...
                <Grid item xs={12} md={12}>
                    <TextField value={form.username} onChange={event => setForm({...form, username: event.target.value})}
                               label="Username" variant="filled" color="success" autoComplete='off'/>
                </Grid>
                <Grid item xs={12} md={12}>
                    <TextField value={form.firstname} onChange={event => setForm({...form, firstname: event.target.value})}
                               label="First name" variant="filled" color="success" autoComplete='off'/>
                </Grid>
                <Grid item xs={12} md={12}>
                    <TextField value={form.lastname} onChange={event => setForm({...form, lastname: event.target.value})}
                               label="Last name" variant="filled" color="success" autoComplete='off'/>
                </Grid>
                <Grid item xs={12} md={12}>
                    <TextField value={form.country} onChange={event => setForm({...form, country: event.target.value})}
                               label="Country" variant="filled" color="success" autoComplete='off'/>
                </Grid>
                <Grid item xs={12} md={12}>
                    <TextField
                ...
                <Grid item xs>
                    {per !== null && per < 100
                        ...
                        : <Button variant="contained" color="success" type='submit' onClick={(e)=>handleAdd(
