            ...
            <Container maxWidth='xs'>
                <Box sx={{paddingTop: 10}}
                    ...
                    <TabContext value={value}>
                        <Box sx={{borderBottom: 1, borderColor: 'divider', color: '#351b7e'}}>
                            <TabList onChange={handleChange} variant='fullWidth'
                                     centered aria-label="lab API tabs example"
                        ...
                        <TabPanel value="1" >
                            <Avatar
                                alt={email}
                                src={ava}
                                sx={{minWidth: 250, minHeight: 250, margin: '0 auto',
                                border: '#351b7e solid'}}
                            />
                        </TabPanel>
                        <TabPanel value="2">
                            <Typography color='#351b7e' sx={{fontSize: 32}} variant='h5' component="span" gutterBottom>
                                Name: {firstnameValue} {lastnameValue}
                            </Typography>

                            <Typography color='#351b7e' sx={{fontSize: 24}} variant='h5' component="div" gutterBottom>
                               Username: {usernameValue}
                            </Typography>
                            <Typography color='#351b7e' variant='h6' component="div" gutterBottom>
